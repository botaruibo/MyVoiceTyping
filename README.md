...
![MyVoiceTyping static walkthrough strip](docs/landing/assets/static-walkthrough-strip.png)
...
| 本地优先 | App / 模型 / 数据集公开 |
| --- | --- |
| ![Local-first privacy](docs/landing/assets/04-local-first-privacy.png) | ![Open app, model, and dataset](docs/landing/assets/05-open-app-model-dataset.png) |

如果你看完仍然不想下载，最有价值的反馈是直接告诉我原因：  
...
| 比较 Typeless / OpenTypeless / 闪电说 / 豆包 | [Typeless 平替快速判断](docs/TYPELESS_ALTERNATIVE.zh-CN.md) · [同类工具对比](docs/ALTERNATIVES.zh-CN.md) |
