...
def demo():
    """完整功能演示 - 重点测试 option 键"""
    print("=" * 70)
    print("Rice Copilot 快捷键系统 - Option 键修复版")
    print("=" * 70)
    print(f"系统: {platform.machine()}, macOS {platform.mac_ver()[0]}")
    print("-" * 70)
    print("重点测试 option 键:")
    print("  单键: option_l, option_r")
    print("  组合: fn+option_l, option_l+cmd_l, option_l+space")
    print("=" * 70)
